...
// FAQ Shortcode
add_shortcode( 'jwt_woofolio', 'jeweltheme_woofolio_shortcode' );
...
ob_start();
    ...
    // WP_Query arguments
    $jwt_woofolio_args = array (
        'post_type'              => 'product',
        'posts_per_page'         => -1,
        );

    // The Query
    $woofolio_query = new WP_Query( $jwt_woofolio_args );
    ?>
                            ...
                            <?php
                                ...
                                if ( $attachment_ids ){
                                     foreach( $attachment_ids as $attachment_id ) {
                                      echo '<div class="slider__item"><img src="' .  wp_get_attachment_image_src( $attachment_id, 'full' )[0] . '" alt="' . get_the_title() . '" /></div>';
                                    }
                                } else {
                                    echo $product_thumb;
