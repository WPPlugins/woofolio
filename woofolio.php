 ...
 * @since             1.1.0
 * @package           WooFolio - WooCommerce Filterable Products
 *
 * @wordpress-plugin
 * Plugin Name:       WooFolio
 * Plugin URI:        http://jeweltheme.com
 * Description:       WooFolio - WooCommerce Filterable Products Showcase with Isotop Masonry Grid
 * Version:           1.1.0
 * Author:            Jewel Theme
